namespace ricetta_dematerializzata.Models
{
    /// <summary>
    /// Catalogo di tutti i servizi disponibili per il sistema SAC / DEM Ricetta.
    /// Usare questo enum come primo parametro di IRicettaDematerializzataClient.Chiama().
    /// </summary>
    public enum DigitalPrescriptionService
    {
        ...
        /// Input:  NRE, cfAssistito (opzionale)
        ...
        /// Input:  cfAssistito o TESSERA_STP
